...
function bitbuffer.readu10(b: buffer, byte: number, bit: number): number
	return if bit > 6 then bit32.extract(readu24(b, byte), bit, 10) else bit32.extract(buffer.readu16(b, byte), bit, 10)
end

function bitbuffer.readu11(b: buffer, byte: number, bit: number): number
	return if bit > 5 then bit32.extract(readu24(b, byte), bit, 11) else bit32.extract(buffer.readu16(b, byte), bit, 11)
end

function bitbuffer.readu12(b: buffer, byte: number, bit: number): number
	return if bit > 4 then bit32.extract(readu24(b, byte), bit, 12) else bit32.extract(buffer.readu16(b, byte), bit, 12)
end

function bitbuffer.readu13(b: buffer, byte: number, bit: number): number
	return if bit > 3 then bit32.extract(readu24(b, byte), bit, 13) else bit32.extract(buffer.readu16(b, byte), bit, 13)
end

function bitbuffer.readu14(b: buffer, byte: number, bit: number): number
	return if bit > 2 then bit32.extract(readu24(b, byte), bit, 14) else bit32.extract(buffer.readu16(b, byte), bit, 14)
end

function bitbuffer.readu15(b: buffer, byte: number, bit: number): number
	return if bit > 1 then bit32.extract(readu24(b, byte), bit, 15) else bit32.extract(buffer.readu16(b, byte), bit, 15)
end

function bitbuffer.readu16(b: buffer, byte: number, bit: number): number
	return if bit > 0 then bit32.extract(readu24(b, byte), bit, 16) else bit32.extract(buffer.readu16(b, byte), bit, 16)
end
...
function bitbuffer.readu18(b: buffer, byte: number, bit: number): number
	return if bit > 6 then bit32.extract(buffer.readu32(b, byte), bit, 18) else bit32.extract(readu24(b, byte), bit, 18)
end

function bitbuffer.readu19(b: buffer, byte: number, bit: number): number
	return if bit > 5 then bit32.extract(buffer.readu32(b, byte), bit, 19) else bit32.extract(readu24(b, byte), bit, 19)
end

function bitbuffer.readu20(b: buffer, byte: number, bit: number): number
	return if bit > 4 then bit32.extract(buffer.readu32(b, byte), bit, 20) else bit32.extract(readu24(b, byte), bit, 20)
end

function bitbuffer.readu21(b: buffer, byte: number, bit: number): number
	return if bit > 3 then bit32.extract(buffer.readu32(b, byte), bit, 21) else bit32.extract(readu24(b, byte), bit, 21)
end

function bitbuffer.readu22(b: buffer, byte: number, bit: number): number
	return if bit > 2 then bit32.extract(buffer.readu32(b, byte), bit, 22) else bit32.extract(readu24(b, byte), bit, 22)
end

function bitbuffer.readu23(b: buffer, byte: number, bit: number): number
	return if bit > 1 then bit32.extract(buffer.readu32(b, byte), bit, 23) else bit32.extract(readu24(b, byte), bit, 23)
end

function bitbuffer.readu24(b: buffer, byte: number, bit: number): number
	return if bit > 0 then bit32.extract(buffer.readu32(b, byte), bit, 24) else bit32.extract(readu24(b, byte), bit, 24)
end
...
function bitbuffer.readu26(b: buffer, byte: number, bit: number): number
	if bit > 6 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu1(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
...
function bitbuffer.readu27(b: buffer, byte: number, bit: number): number
	if bit > 5 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu2(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
...
function bitbuffer.readu28(b: buffer, byte: number, bit: number): number
	if bit > 4 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu3(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
...
function bitbuffer.readu29(b: buffer, byte: number, bit: number): number
	if bit > 3 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu4(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
...
function bitbuffer.readu30(b: buffer, byte: number, bit: number): number
	if bit > 2 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu5(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
...
function bitbuffer.readu31(b: buffer, byte: number, bit: number): number
	if bit > 1 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu6(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
...
function bitbuffer.readu32(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu7(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
...
function bitbuffer.readu33(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu8(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu8(b, byte + 4) % 0x2 * 0x100000000
	end
end
...
function bitbuffer.readu34(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu9(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu8(b, byte + 4) % 0x4 * 0x100000000
	end
end
...
function bitbuffer.readu35(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu10(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu8(b, byte + 4) % 0x8 * 0x100000000
	end
end
...
function bitbuffer.readu36(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu11(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu8(b, byte + 4) % 0x10 * 0x100000000
	end
end
...
function bitbuffer.readu37(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu12(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu8(b, byte + 4) % 0x20 * 0x100000000
	end
end
...
function bitbuffer.readu38(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu13(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu8(b, byte + 4) % 0x40 * 0x100000000
	end
end
...
function bitbuffer.readu39(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu14(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu8(b, byte + 4) % 0x80 * 0x100000000
	end
end
...
function bitbuffer.readu40(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu15(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu8(b, byte + 4) * 0x100000000
	end
end
...
function bitbuffer.readu41(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu16(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu16(b, byte + 4) % 0x200 * 0x100000000
	end
end
...
function bitbuffer.readu42(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu17(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu16(b, byte + 4) % 0x400 * 0x100000000
	end
end
...
function bitbuffer.readu43(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu18(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu16(b, byte + 4) % 0x800 * 0x100000000
	end
end
...
function bitbuffer.readu44(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu19(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu16(b, byte + 4) % 0x1000 * 0x100000000
	end
end
...
function bitbuffer.readu45(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu20(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu16(b, byte + 4) % 0x2000 * 0x100000000
	end
end
...
function bitbuffer.readu46(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu21(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu16(b, byte + 4) % 0x4000 * 0x100000000
	end
end
...
function bitbuffer.readu47(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu22(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu16(b, byte + 4) % 0x8000 * 0x100000000
	end
end
...
function bitbuffer.readu48(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu23(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + buffer.readu16(b, byte + 4) * 0x100000000
	end
end
...
function bitbuffer.readu49(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu24(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + readu24(b, byte + 4) % 0x20000 * 0x100000000
	end
end
...
function bitbuffer.readu50(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA = bit + 25
		return bitbuffer.readu25(b, byte, bit) + bitbuffer.readu25(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
	else
		return buffer.readu32(b, byte) + readu24(b, byte + 4) % 0x40000 * 0x100000000
	end
end

function bitbuffer.readu51(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		local offsetA, offsetB = bit + 25, bit + 50
		return bitbuffer.readu25(b, byte, bit)
			+ bitbuffer.readu25(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
			+ bitbuffer.readu1(b, byte + offsetB // 8, offsetB % 8) * 0x4000000000000
	else
		return buffer.readu32(b, byte) + readu24(b, byte + 4) % 0x80000 * 0x100000000
	end
end
...
function bitbuffer.readu52(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		...
		return bitbuffer.readu25(b, byte, bit)
			+ bitbuffer.readu25(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
			+ bitbuffer.readu2(b, byte + offsetB // 8, offsetB % 8) * 0x4000000000000
	else
		return buffer.readu32(b, byte) + readu24(b, byte + 4) % 0x100000 * 0x100000000
	end
end
...
function bitbuffer.readu53(b: buffer, byte: number, bit: number): number
	if bit > 0 then
		...
		return bitbuffer.readu25(b, byte, bit)
			+ bitbuffer.readu25(b, byte + offsetA // 8, offsetA % 8) * 0x2000000
			+ bitbuffer.readu3(b, byte + offsetB // 8, offsetB % 8) * 0x4000000000000
	else
		return buffer.readu32(b, byte) + readu24(b, byte + 4) % 0x200000 * 0x100000000
	end
end
...
function bitbuffer.writeu33(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu8(b, byte + 4, bit32.replace(buffer.readu8(b, byte + 4), value // 0x100000000, 0, 1))
	end
end
...
function bitbuffer.writeu34(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu8(b, byte + 4, bit32.replace(buffer.readu8(b, byte + 4), value // 0x100000000, 0, 2))
	end
end
...
function bitbuffer.writeu35(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu8(b, byte + 4, bit32.replace(buffer.readu8(b, byte + 4), value // 0x100000000, 0, 3))
	end
end
...
function bitbuffer.writeu36(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu8(b, byte + 4, bit32.replace(buffer.readu8(b, byte + 4), value // 0x100000000, 0, 4))
	end
end
...
function bitbuffer.writeu37(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu8(b, byte + 4, bit32.replace(buffer.readu8(b, byte + 4), value // 0x100000000, 0, 5))
	end
end
...
function bitbuffer.writeu38(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu8(b, byte + 4, bit32.replace(buffer.readu8(b, byte + 4), value // 0x100000000, 0, 6))
	end
end
...
function bitbuffer.writeu39(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu8(b, byte + 4, bit32.replace(buffer.readu8(b, byte + 4), value // 0x100000000, 0, 7))
	end
end
...
function bitbuffer.writeu41(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu16(b, byte + 4, bit32.replace(buffer.readu16(b, byte + 4), value // 0x100000000, 0, 9))
	end
end
...
function bitbuffer.writeu42(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu16(b, byte + 4, bit32.replace(buffer.readu16(b, byte + 4), value // 0x100000000, 0, 10))
	end
end
...
function bitbuffer.writeu43(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu16(b, byte + 4, bit32.replace(buffer.readu16(b, byte + 4), value // 0x100000000, 0, 11))
	end
end
...
function bitbuffer.writeu44(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu16(b, byte + 4, bit32.replace(buffer.readu16(b, byte + 4), value // 0x100000000, 0, 12))
	end
end
...
function bitbuffer.writeu45(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu16(b, byte + 4, bit32.replace(buffer.readu16(b, byte + 4), value // 0x100000000, 0, 13))
	end
end
...
function bitbuffer.writeu46(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu16(b, byte + 4, bit32.replace(buffer.readu16(b, byte + 4), value // 0x100000000, 0, 14))
	end
end
...
function bitbuffer.writeu47(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		buffer.writeu16(b, byte + 4, bit32.replace(buffer.readu16(b, byte + 4), value // 0x100000000, 0, 15))
	end
end
...
function bitbuffer.writeu49(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		writeu24(b, byte + 4, bit32.replace(readu24(b, byte + 4), value // 0x100000000, 0, 17))
	end
end
...
function bitbuffer.writeu50(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		writeu24(b, byte + 4, bit32.replace(readu24(b, byte + 4), value // 0x100000000, 0, 18))
	end
end
...
function bitbuffer.writeu51(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		writeu24(b, byte + 4, bit32.replace(readu24(b, byte + 4), value // 0x100000000, 0, 19))
	end
end
...
function bitbuffer.writeu52(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		writeu24(b, byte + 4, bit32.replace(readu24(b, byte + 4), value // 0x100000000, 0, 20))
	end
end
...
function bitbuffer.writeu53(b: buffer, byte: number, bit: number, value: number)
	if bit > 0 then
		...
		buffer.writeu32(b, byte, value)
		writeu24(b, byte + 4, bit32.replace(readu24(b, byte + 4), value // 0x100000000, 0, 21))
	end
end
...
function bitbuffer.write(b: buffer, offset: number, width: number, value: number)
	writeLookup[width](b, offset // 8, offset % 8, value)
end

function bitbuffer.read(b: buffer, offset: number, width: number): number
	return readLookup[width](b, offset // 8, offset % 8)
end
